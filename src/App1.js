  ...
  return (
    <div className="container-fluid">
      ...
      <div className="mb-4" style={{ textAlign: 'right' }}>
        <a to="/slideshow_add" style={{ backgroundColor: '#28a745', color: 'white', borderRadius: '4px', padding: '8px 12px', textDecoration: 'none' }}>
          + New
        </a>
      </div>
            ...
            <table className="table">
              ...
              <tbody className="table-border-bottom-0">
                {slideshows.length > 0 ? slideshows.map((row) => {
                  const imagePath = row.image ? row.image : 'images/logos/placeholder2.jpg';
                  ...
                  return (
                    <tr key={row.id}>
                      ...
                      <td>{row.title}</td>
                      <td>
                        <img src={imagePath} alt="Slideshow Image" className="product-img" style={{ width: '100px', height: '50px', objectFit: 'cover', borderRadius: '5px', boxShadow: '2px 2px 2px rgba(0, 0, 0, 0.3)' }} />
                      </td>
